...
public class createsale extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Create Sale Record");
...
try{ 
  ...
  try{
     ...
     String query = "Insert into sale values('"+mk+"','" + ml+"','"+ mj+"','"+ md+"','" + mt+"','"+ mm+"','"+ mq+"');";
     stmt.executeUpdate(query);
     String query2 = "update inventory set stock = stock - '"+mt+"' where itemid = '"+md+"';"; 
